              ...
              <div key={index} className="space-y-2 p-4 border rounded-md">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    newDeliverables[index] = { ...newDeliverables[index], title: e.target.value }
                    setFormData((prev) => ({
                      ...prev,
                ...
                <input
                  ...
                  onChange={(e) => {
                    const newDeliverables = [...formData.deliverables]
                    newDeliverables[index] = { ...newDeliverables[index], due_date: e.target.value }
                    setFormData((prev) => ({
                      ...prev,
                      deliverables: newDeliverables,
                    }))
                ...
                <select
                  ...
                  onChange={(e) => {
                    const newDeliverables = [...formData.deliverables]
                    newDeliverables[index] = { ...newDeliverables[index], status: e.target.value }
                    setFormData((prev) => ({
                      ...prev,
                      deliverables: newDeliverables,
                    }))
              ...
              <div key={index} className="space-y-2 p-4 border rounded-md">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (file) {
                      const newMilestones = [...formData.milestones]
                      newMilestones[index] = { ...newMilestones[index], media: file }
                      setFormData((prev) => ({
                        ...prev,
                        milestones: newMilestones,
                      }))
